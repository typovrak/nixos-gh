...
let
  nixos-gh = fetchGit {
    url = "https://github.com/<YOUR_USERNAME>/nixos-gh.git";
    ref = "main";
...
```bash
git clone https://github.com/<YOUR_USERNAME>/nixos-gh.git &&
cd nixos-gh &&
...
- 📘 [GitHub CLI documentation](https://cli.github.com/manual) : Official reference for all ```gh``` commands.
